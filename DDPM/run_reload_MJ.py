...
if model_name =='Unet':
    ...
    model = model = Unet1D(dim = init_dim, dim_mults = dim_mults, channels=1,     
...
np.save(str(trainer.RESULTS_FOLDER / f'samples_model-{last_milestone}'), all_ops.numpy())